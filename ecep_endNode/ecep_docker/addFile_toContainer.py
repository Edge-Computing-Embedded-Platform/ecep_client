...
<<<<<<< Updated upstream
    ...
    def copyFileTo_container(self, **kwargs):
        ...
        if self._count == 0:
            print (
            'containerName: ,containerPath: ,localPath: ', self._containerName, self._containerPath, self._localPath)
    ...
    def run_shellScript(self, **kwargs):
        ...
        if self._count == 1:
            ...
            _shellscript = {'container_name': self._containerName, 'containerpath': self._containerPath,
...
=======
	...
	def copyFileTo_container(self, **kwargs):
		...
		_transferApp = {'container_name': self._containerName,'containerpath': self._containerPath, 'local_path': self._localPath}
		...
		if _successful:
			...
			if _checkStatus:
				_executeScript = {'container_name':self._containerName,'user':self._user}
		...
		print ('_execStart_response1: ',_execStart_response) 
...
if __name__ == "__main__":
	...
	obj = addFile()
	name = {'container_name' : 'evil_brattain'}
	obj.startContainer_toAddFile(**name)
	
	data = {'container_name':'evil_brattain',\
	'containerpath':'/home/',\
...
>>>>>>> Stashed changes
    ...
    obj.startContainer_toAddFile(**name)
    # time.sleep(10)
    data = {'container_name': 'nostalgic_bhabha', 'containerpath': '/',
            'local_path': '/home/parallels/Downloads/for_testing.tar', 'file': 'temp.tar'}
    obj.copyFileTo_container(**data)
