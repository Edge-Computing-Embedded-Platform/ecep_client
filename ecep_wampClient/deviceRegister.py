...
import threading
import time
from wamp_client import sendTo, wampserver
...
class periodicTransmit(object):
    ...
    def heartbeat(self):
        while True:
            ...
            self._heartbeatData['archi'] = cpu_info.getMachineArchitecture()
...
if __name__ == "__main__":
    ...
    #topics to listen to
    topics = {'cmd':'com.ecep.beaglebone.cmd'}
    
    client = wampserver(topics)
