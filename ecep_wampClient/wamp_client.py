...
# from callContainer_api import callContainer as cc
...
class ClientReader(ApplicationSession):
    ...
    def onJoin(self, details):
        ...
        self.cmd = self.config.extra['cmd']
        ...
        try:
            yield self.subscribe(contcmd, self.cmd)
            print ("Subscribed to topic: " + self.cmd)
        except Exception as e:
            print("could not subscribe to topic:" + self.cmd + " : " + e)
...
if __name__ == '__main__':
    ...
    topics = {'cmd': 'com.ecep.beaglebone.cmd', 'abhi': 'name'}
    server = wampserver()
